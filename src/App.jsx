...
const styles = {
  ...
  clueText: { fontSize: 15, lineHeight: 1.7, color: "#1c0a00", margin: "0 0 12px", fontFamily: "'Lora', Georgia, serif", fontStyle: "italic" },
  directiveLine: { height: 1, background: "rgba(220,38,38,0.25)", marginBottom: 10, borderTop: "1px dashed rgba(220,38,38,0.3)" },
  clueQuestion: { fontSize: 15, fontWeight: 700, color: "#dc2626", margin: 0, letterSpacing: "0.01em", fontFamily: "'Playfair Display', Georgia, serif" },
